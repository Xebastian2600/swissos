# Contributing to SwissOS Translations

First off, thank you for considering contributing to SwissOS translations! Your efforts help make SwissOS accessible to a global audience. This guide will walk you through the process of adding or updating language translations for the SwissOS platform and its various extensions.

## Understanding the Structure

SwissOS is a modular system. The main application, known as SwissOS Console, has its own set of translations. Additionally, each extension (like FleetOps or Storefront) also contains its own translation files. This means that to provide a complete translation for a specific language, you may need to contribute to multiple repositories.

- **Main Application (`karlrodriguez/swissos`)**: Contains the core translation files for the SwissOS Console.
- **Extensions/Modules**: Each extension has its own repository and its own set of translation files. These extension packages are upstream Fleetbase projects consumed as dependencies, so their translation contributions go to Fleetbase's own repositories, not SwissOS's.
...
- In the main `karlrodriguez/swissos` repository, the translation files are located at `./console/translations/`.
...
First, you need to fork the repository you want to contribute to. This could be the main `karlrodriguez/swissos` repository or one of the extension repositories. After forking, clone it to your local machine.
...
Once you have finished translating, commit your changes and push them to your forked repository. Then, open a pull request to the original repository.

- Make sure your pull request has a clear title and description of the changes you made.
- If you are translating an extension, you may need to submit a pull request to the extension's repository. If your changes also affect the main console, a separate PR to the `karlrodriguez/swissos` repository might be necessary.

Your contribution will be reviewed by the project team, and once approved, it will be merged into the project.
...
| ---------------------------------------- | ----------------------------- |
| [karlrodriguez/swissos][1]               | `./console/translations/`     |
...
[1]: https://github.com/karlrodriguez/swissos
...
Thank you again for your contribution to the SwissOS community!
