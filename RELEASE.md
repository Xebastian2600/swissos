...
---
## Highlights
SwissOS `0.7.63` ships Fleet-Ops `0.6.68`. Telematics connections now show their real sync state: completed background sweeps update the status and last sync time, and "Sync Devices" works while polling is running. SASCO joins PetroApp as a native fuel provider.
...
---
## Need help?
Join the discussion on [GitHub Discussions](https://github.com/orgs/karlrodriguez/discussions)
