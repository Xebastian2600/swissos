...
module('Unit | Instance Initializer | initialize-widgets', function () {
    ...
    test('the widgets are registered once the universe boots', function (assert) {
        ...
        assert.ok(ids.includes('swissos-blog'), 'the blog widget is registered on the dashboard');
        assert.ok(ids.includes('swissos-github-card'), 'the github card widget is registered on the dashboard');
