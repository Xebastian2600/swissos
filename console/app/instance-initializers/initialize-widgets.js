...
/**
 * Register dashboard and widgets for SwissOS Console
    ...
    universe.onBoot(() => {
        ...
        const widgets = [
            new Widget({
                ...
                icon: 'newspaper',
                component: 'swissos-blog',
                grid_options: { w: 7, h: 9, minW: 7, minH: 9 },
                default: true,
            }),
            new Widget({
                id: 'swissos-github-card',
                name: 'Github Card',
                description: 'Displays current Github stats from the SwissOS repo.',
                icon: faGithub,
