 ...
 *
 * This file is automatically generated by the SwissOS extension build system.
 * Any manual changes will be overwritten on the next build.
 *
 * @generated
 * @copyright © ${year} Fleetbase Pte Ltd and SwissOS contributors. Licensed under AGPL-3.0-or-later.
...
`;
    ...
    included() {
        ...
        console.log('\n' + '/'.repeat(70));
        console.log('[SwissOS] Extension Build System');
    ...
    async generateExtensionFiles() {
        ...
        if (fs.existsSync(extensionsDir)) {
            console.log('[SwissOS] Cleaning up old extensions directory...');
        ...
        if (extensions.length > 0) {
            console.log(`[SwissOS] Discovered ${extensions.length} extension(s)`);
            extensions.forEach((ext) => {
                console.log(`[SwissOS]   - ${ext.name} (v${ext.version})`);
            });
            console.log('');
            ...
            console.log('[SwissOS] No extensions found — generating empty extension loader to satisfy module dependencies.');
        }
    ...
    generateExtensionShims(extensions) {
        ...
        extensions.forEach((extension) => {
            ...
            console.log(`[SwissOS]   ✓ Generated app/extensions/${mountPath}.js`);
        });
    },
...
`;
        ...
        console.log(`[SwissOS]   ✓ Generated app/extensions/index.js`);
    },
    ...
    generateRouter(extensions) {
        ...
        console.log(`[SwissOS]   ✓ Generated app/router.js`);
    },
    ...
    generateExtensionsManifest(extensions) {
        ...
        console.log(`[SwissOS]   ✓ Generated public/extensions.json`);
    },
    ...
    watchExtensionFiles() {
        ...
        this.getExtensions().then((extensions) => {
            ...
            watcher.on('change', (filePath) => {
                console.log(`\n[SwissOS] Extension file changed: ${path.basename(filePath)}`);
                console.log('[SwissOS] Regenerating extension files...\n');
