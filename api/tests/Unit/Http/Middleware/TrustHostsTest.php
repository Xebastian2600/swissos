...
class TrustHostsTest extends TestCase
{
    ...
    {
        config(['app.url' => 'https://swissos.example.com']);
        ...
        $this->assertMatchesRegularExpression($pattern, 'swissos.example.com');
        $this->assertMatchesRegularExpression($pattern, 'tenant.swissos.example.com');
        $this->assertDoesNotMatchRegularExpression($pattern, 'swissos.example.com.evil.test');
    }
}
