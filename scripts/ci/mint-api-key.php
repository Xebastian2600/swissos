...
//
// CI helper: mint a working SwissOS public-API key against a booted stack.
//
...
try {
    ...
    $user = \Fleetbase\Models\User::where('email', 'ci-contract@swissos.local')->first();
    if (!$user) {
        $user               = new \Fleetbase\Models\User();
        $user->name         = 'CI Contract User';
        $user->email        = 'ci-contract@swissos.local';
    ...
    /* ============================================================
     | CUSTOMER FIXTURES (SwissOS API / Customers)
     * ============================================================ */

    $customerIdentity = getenv('CI_CUSTOMER_IDENTITY') ?: 'ci-customer@swissos.local';
    ...
    // contact of its own.
    $newCustomerIdentity = getenv('CI_NEW_CUSTOMER_IDENTITY') ?: 'ci-new-customer@swissos.local';
    ...
    /* ============================================================
     | DRIVER FIXTURES (SwissOS API / Drivers)
     * ============================================================ */
    ...
    $driverIdentity = getenv('CI_DRIVER_IDENTITY') ?: 'ci-driver@swissos.local';
    ...
    /* ============================================================
     | INSPECTION FORM (SwissOS API / Inspections)
     * ============================================================ */
    ...
    /* ============================================================
     | LEDGER INVOICE FIXTURE (SwissOS Ledger API / Public Invoices)
     * ============================================================ */
